...
namespace Cui_Jall_Restraurent__Management
{
      ...
      public void Reset() 
        ...
        private void btnSave_Click(object sender, EventArgs e) 
        {
            ...
            if (txtCustomerID.Text == "")
                {
                    MessageBox.Show("Please retieve Customer Info", "", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            button1.Focus();
            return;
            }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
                ...
                if (txtCustomerID.Text == "")
                {
                    MessageBox.Show("Please retieve CustomerInfo", "", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    button1.Focus();
                    return;
                }
                if (DataGridView1.Rows.Count == 0)
                ...
                cc.con = new SqlConnection(cs.DBConn);
                cc.con.Open();
                string cb = "update OrderedProduct set CustomerID=" + txtC_Id.Text + ", GrandTotal=" + txtGrandTotal.Text + ",Cash=" + txtCash.Text + ",Change=" + txtChange.Text + " where B_ID=" + txtID.Text + "";
                cc.cmd = new SqlCommand(cb);
                cc.cmd.Connection = cc.con;
                cc.cmd.ExecuteNonQuery();
                if (cc.con.State == ConnectionState.Open)
        ...
        private void showReal()
        {
            ...
            if (cc.rdr.Read())
            {
                Label13.Text = cc.rdr.GetValue(0).ToString();
    ...
    //---------------
        private void btnGetData_Click(object sender, EventArgs e)
        {
            ...
            CustomerBillingRecord frm = new CustomerBillingRecord();
            frm.Reset();
        ...
        {
            this.Hide();
           Customer_Entry_Record frm = new Customer_Entry_Record();
        ...
        //Showing Real time money to back for customer
        //--------------------------------------------
        ...
        //Calculating Grand total by all DataGrid data
        //--------------------------------------------
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            //Showing all the calculate data to the data grid view(lower Bellow)
                foreach (DataGridViewRow r in this.DataGridView1.Rows)
                {
        ...
        //Will fill up the combo box for product
        //--------------------------------------
        ...
        // Given amount is stock or not //No call
        //---------------------------------------
        ...
        private void billPrint_Click(object sender, EventArgs e)
        {
            ...
            connectionString = @"Data Source=(LocalDB)\v11.0;AttachDbFilename=F:\Temporal Project Place\Cui Jall Restraurent  Management\Cui Jall Restraurent  Management\ChuiJhalManagement.mdf;Integrated Security=True";
            ...
            xlWorkBook.SaveAs("ChujhalRestaurent.xls", Excel.XlFileFormat.xlWorkbookNormal, misValue, misValue, misValue, misValue, Excel.XlSaveAsAccessMode.xlExclusive, misValue, misValue, misValue, misValue, misValue);
            ...
            MessageBox.Show("Excel file created , you can find the file c:\\ChujhalRestaurent.xls");
        ...
        public int CustomerBillCalculation(int p1, int p2, int p3)
        {
            int totalBillAmount = (p1 + p2 + p3);
