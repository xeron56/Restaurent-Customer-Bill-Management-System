...
namespace Cui_Jall_Restraurent__Management
{
    public partial class Customer_Entry : Form
    {
        ...
        private void delete_records()
        {
                ...
                cc.con.Open();
                string ct = "delete from Customer where C_ID=@d1";
                ...
                {
                    st1 = lblUser.Text;
                    st2 = "deleted the Customer'" + txtCustomerName.Text + "' having Customer id '" + txtCustomerID.Text + "'";
     ...
     //Close============================================================================================
        ...
        public void auto()
        {
                ...
                cc.con = new SqlConnection(cs.DBConn);
                cc.con.Open();
                string sql = "SELECT MAX(C_ID+1) FROM Customer";
        ...
        public void btnSave_Click(object sender, EventArgs e)
        {
            ...
            return;
                ...
                cc.con = new SqlConnection(cs.DBConn);
                cc.con.Open();
                string cb = "insert into Customer(C_ID,CustomerID,Name,Address,City,ContactNo,Email,Photo) VALUES (@d1,@d2,@d3,@d4,@d5,@d6,@d7,@d8)";
                ...
                cc.con.Close();
                st1 = lblUser.Text;
                st2 = "added the new Customer'" + txtCustomerName.Text + "' having Customer id '" + txtCustomerID.Text + "'";
                cf.LogFunc(st1, System.DateTime.Now, st2);
      ...
      //Update=============================================================================
        private void btnUpdate_Click(object sender, EventArgs e)
        {
                  ...
                  cc.con = new SqlConnection(cs.DBConn);
                  cc.con.Open();
                  string cb = "Update Customer set CustomerID=@d2,Name=@d3,Address=@d4,City=@d5,ContactNo=@d6,Email=@d7,Photo=@d8 where C_ID=@d1";
                  cc.cmd = new SqlCommand(cb);
                  cc.cmd.Connection = cc.con;
                  cc.cmd.Parameters.AddWithValue("@d1", txtID.Text);
                  cc.cmd.Parameters.AddWithValue("@d2", txtCustomerID.Text);
                  ...
                  cc.con.Close();
                  st1 = lblUser.Text;
                  st2 = "updated the Customer'" + txtCustomerName.Text + "' having Customer id '" + txtCustomerID.Text + "'";
                  cf.LogFunc(st1, System.DateTime.Now, st2);
                btnUpdate.Enabled = false;
